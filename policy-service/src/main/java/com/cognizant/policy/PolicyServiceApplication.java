...
import com.cognizant.policy.repository.BenefitsRepo;
import com.cognizant.policy.repository.HospitalRepo;
import com.cognizant.policy.repository.MemberPolicyRepo;
import com.cognizant.policy.repository.PolicyRepo;

@SpringBootApplication
@ComponentScan(basePackages = "com.cognizant.policy")
@EnableFeignClients
public class PolicyServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception{
		...
		MemberPolicy m1=new MemberPolicy("M101","P1001",2,"10/11/2023","01/02/2012");
		MemberPolicy m2 = new MemberPolicy("M102","P1002",13,"10/04/2023","16/12/2017");
