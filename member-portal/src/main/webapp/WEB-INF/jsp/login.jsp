				...
				<div class="container">
					<div class="row">
						<div
							...
							<div class="page-title text-center">
								<h3 style="font-size: 50px;">Login <span class="primary">Page</span></h3>
							</div>
						</div>
					</div>
				</div>

				<div class="container" style="margin-left:35%; width:65%">
						...
						<spring:bind path="username">
							<div class="form-outline mb-4">
								...
								<form:input path="username" type="text"
									...
									id="username" placeholder="Username" style="width:40%;"/>
						...
						<spring:bind path="password">
							<div class="form-outline mb-4">
								...
								<form:input path="password" type="password"
									class="form-control ${status.error ? 'is-invalid' : ''}"
									id="password" placeholder="Password" style="width:40%;"/>
