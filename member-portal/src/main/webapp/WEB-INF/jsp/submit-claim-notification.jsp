			...
			<div class="pt-tablecell page-contact relative">
				...
				<div class="page-title text-center">
					<a style="text-decoration: none;" href="home">
						<h2>Claims <span class="primary">Management</span> <span class="title-bg">Services</span></h2>
					</a>
				</div>
						...
						<div
							...
							<div class="page-title text-center">
								<h3 style="font-size: 50px;">
									Claim <span class="primary">Details</span>
								</h3>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<table class="table table-hover table-dark" border=1>
						<tbody>
							<tr>
								<td>ClaimID</td>
								<td>${claimstatusdto.claimId}</td>
							</tr>

							<tr>
								<td>Claim Status</td>
								<td>${claimstatusdto.claimStatus}</td>
							</tr>

							<tr>
								<td>Claim Description</td>
								<td>${claimstatusdto.claimDescription}</td>
							</tr>
						</tbody>
					</table>
				</div>
